...
public class AdoptanteServicio {
    ...
    public Adoptante registrar(Adoptante a, BCryptPasswordEncoder passwordEncoder) throws MessagingException {
        a.setContrasena(passwordEncoder.encode(a.getContrasena()));
        emailServicio.enviarEmail(a.getEmail(), "Cats&Dogs Shelter",
                "<!DOCTYPE html>\n" +
                        ...
                        "                            <h1 style=\"margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;\">Bienvenido "+ a.getNombre() +" Cats&Dogs shelter!</h1>\n" +
                        "                            <p style=\"margin:0;\">Con nosotros disfrutaras del mejor contenido de animales de toda la red. Aqui podras conocer animales, personas, protectoras, etc. Podrás contactar con diferentes asociaciones y consultarles sobre su adopción sobre algún animal, podras ver si necesitan voluntario o simplemente disfrutar de las historias de nuestros amigos</p>\n" +
                        "                        </td>\n" +
                        "                    </tr>\n" +
                        "                    <tr>\n" +
                        ...
                        "                                <p style=\"margin-top:0;margin-bottom:12px;\">Estamos encantados de tenerte entre los miembros de nuestra familia y te estamos agradecidos por\n" +
                        "                                                                            confiar en nosotros. Recordarte que esto es para tu disfrute y para el de todos y que igual que tú\n" +
                        "                                                                            vienes a ver animales hay otras personas o entidades que quieren adoptar o dar en adopción a nuestros\n" +
                        "                                                                            amigos asi que intenta ser lo más respetuoso posible al establecer comunicación con otras personas\n" +
                        "                                                                            pues no se toleraran faltas de respeto. ¡Gracias de nuevo y bienvenido!</p>\n" +
                        ...
                        "                            <p style=\"margin:0 0 8px 0;\"></a> <a href=\"https://twitter.com/intent/tweet?text=Me+acabo+de+registrar+en+Cats%26Dog+Shelter.+Una+plataforma+donde+encontrar+protectoras+de+animales+para+adoptar+perros+y+gatos.+%0d%0a%c2%bfTe+unes%3f+%c2%a1Es+gratis!%0d%0awww.catsanddogshelter.com\" style=\"text-decoration:none;\"><img src=\"https://assets.codepen.io/210284/twitter_1.png\" width=\"40\" height=\"40\" alt=\"t\" style=\"display:inline-block;color:#cccccc;\"></a></p>\n" +
                        ...
                        "</body>\n" +
                        "</html>");
        return adoptanteRepositorio.save(a);
    }

    public Adoptante setPerfil(Adoptante adoptante, String nombre, String apellidos, String email, String telefono){
